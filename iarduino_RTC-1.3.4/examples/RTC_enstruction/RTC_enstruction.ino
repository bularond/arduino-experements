...
//  Раскомментируйте для программной реализации шины I2C:   //
  #define pin_SW_SDA 7                                      // Назначение любого вывода Arduino для работы в качестве линии SDA программной шины I2C.
  #define pin_SW_SCL 6                                      // Назначение любого вывода Arduino для работы в качестве линии SCL программной шины I2C.
                                                            // переназначение пинов связи работает без подключения  Wire.h
...
void setup(){                                               //
    ...
    delay(300);
    //watch.settime(-1, 3, 15, 13, 2, 20, 4);
}                                                           //
void loop(){                                                //
